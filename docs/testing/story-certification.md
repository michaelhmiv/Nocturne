...
The four release narratives are *Three Keys on Hester Street* (residences/claims/pronouns/routes), *The Last Shift at Orchard Market* (jobs, trading, competition and wages), *Smoke on the Block* (offline consequences, damage, investigation and repairs), and *The Blue Sedan and the Wrong Man* (unique ownership, mistaken identity, evidence, news and replay).
