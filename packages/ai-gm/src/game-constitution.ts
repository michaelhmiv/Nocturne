...
export const NOCTURNE_GAME_CONSTITUTION: GameConstitution =
  GameConstitutionSchema.parse({
...
export function estimateGameMasterContextTokens(
  context: Omit<GameMasterContext, "estimatedTokens">,
) {
