...
describe("starter city surface", () => {
  it.each(SURFACE)(
    "$command → $family → $sourceKey",
    ({ command, family, sourceKey, primitive }) => {
